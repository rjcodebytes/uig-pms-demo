...
<section class="section dashboard">
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <form method="GET" action="{{ url('approver/procurement') }}" class="d-flex align-items-center">
    ...
    @endphp
        ...
        <td style="text-align: center">{{$workflow->status}}</td>
        <td style="text-align: center; display:flex;justify-content: space-evenly;">

          <a type="button" href="{{ url('approver/procurement/view/' . $document->doc_id) }}"
        ...
        <a type="button" href="{{ url('approver/procurement/response/' . $document->doc_id) }}"
        ...
        <span class="hover-text">Submit</span>
        </a>
      @endif
    ...
    @else
      <p>No Procrument request found.</p>
    @endif
