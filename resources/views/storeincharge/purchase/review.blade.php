...
<div class="pagetitle">
  <nav>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="{{ url('storeincharge/purchase')}}">Purchase Request</a></li>
        <li class="breadcrumb-item active"><a href="#">Forward Request</a></li>
    </ol>
  </nav>
</div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="pt-4 pb-2">
                        <h5 class="card-title text-center pb-0 fs-4">Forward Request</h5>
                        <p class="text-center small">Submit your response to forward purchase request.</p>
                        </div>

                        <form class="row g-3" action="{{  url('/forward-request/'.$document->doc_id) }}" method="post">
                            {{ csrf_field() }}
                            ...
                            <div class="d-flex justify-content-center align-items-center mt-4">
                                <div class="col-3">
                                    <button type="submit" class="btn btn-primary w-100">Forward To Store Keeper</button>
                                </div>
                                <div class="col-3 ms-3">
                                    <a href="{{ url()->previous() }}" class="btn btn-secondary w-100">Back To List</a>
                                </div>
                            </div>
                        </form>
                </div>
